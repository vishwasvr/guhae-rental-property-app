...
def lambda_handler(event, context):
    ...
    try:
        ...
        # Finance endpoints
            ...
            return get_property_finance(property_id, headers)
...
def get_property_finance(property_id, headers):
    """Get finance data for a property."""
    try:
        print(f"Getting finance data for property: {property_id}")
...
def update_property_finance(property_id, event, headers):
    ...
    try:
        print(f"Updating finance data for property: {property_id}")
        data = json.loads(event['body'])
